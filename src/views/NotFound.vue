<template>
    <main class="m-auto h-full place-items-center bg-white dark:bg-gray-800 px-6 py-24 sm:py-32 lg:px-8">
        <div class="text-center">
            ...
            <p class="mt-6 text-base leading-7 text-gray-600 dark:text-gray-400">Sorry, we couldn’t find the page you’re looking for.</p>
            <div class="mt-10 flex items-center justify-center gap-x-6">
                <a href="/"
                    ...
                    back home</a>
                <a href="/developer" class="text-sm font-semibold text-gray-900 dark:text-white">Contact support <span
